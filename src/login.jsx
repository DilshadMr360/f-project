        ...
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8  md:w-4/12 bg-black bg-opacity-75 rounded-lg">
          ...
          <form className="space-y-4 md:space-y-6" action="#">
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 w-60 font-kanit bg-sky-600 hover:bg-sky-400 text-white  py-4 px-4 mt-2 rounded-lg font-light   text-xl text-center "
              >
                Sign In
              </button>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <Link to="/register">
                <a
                  href="#"
                  className="font-bold hover:underline text-xl text-sky-500"
                >
                  Sign Up
                </a>
              </Link>
